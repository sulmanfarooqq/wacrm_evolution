...
export async function GET(
  ...
  try {
    ...
    // account post-multi-user, so a teammate fetching media needs the
    // account's config, not their personal (non-existent) row.
    ...
    // Fetch the media bytes from the Evolution instance on demand.
